		...
		<>
			...
			>
				<Image
					...
					sx={{ opacity: 0.6 }}
				/>
				<CustomTypography variant='h4' sx={{ position: 'absolute', color: '#fff' }} fontSize={{ md: 40, xs: 25 }} p={3}>
			...
			<Box
				...
				// define a direção dos itens (vertical para telas pequenas e horizontal para telas médias e acima)
				alignItems={'center'}
				justifyContent={'center'}
			>
				<Image
					...
					alt='Circuitos'
					sx={{ maxHeight: { xs: '100%', md: 400 }, mx: 5, my: 10 }}
				/>
				<Box px={6} pt={{ xs: 0, md: 10 }} pb={10}>
					<CustomTypography variant={'h4'} gutterBottom>
						{messages.homePage.objetivos}
					</CustomTypography>
					<CustomTypography> {messages.homePage.objetivosTexto} </CustomTypography>
				</Box>
			</Box>
			<Box
				bgcolor={'#00b59f'}
			...
			>
				<Box px={6} py={{ xs: 2, md: 10 }} pt={{ xs: 10, md: 10 }}>
					...
					<CustomTypography> {messages.homePage.porqueReciclarTexto} </CustomTypography>
				</Box>
				<Image
					sx={{
						width: { md: '100%' },
