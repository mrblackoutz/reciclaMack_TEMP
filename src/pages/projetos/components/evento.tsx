...
const DetalhesEvento: React.FC<DetalhesEventoProps> = props => {
	...
	return (
		<Box sx={{ width: '100%', height: 580, position: 'relative' }}>
			...
			>
				<CustomTypography variant='h4' component='div' gutterBottom sx={{ color: 'white', fontWeight: 700 }}>
					{titulo}
				</CustomTypography>
				<CustomTypography variant='subtitle1' sx={{ color: 'white', fontSize: 26, fontWeight: 500 }}>
					Data: {data} <br /> Local: {local} <br /> Hora: {hora}
				</CustomTypography>
				<CustomTypography variant='body1' sx={{ color: 'white', fontSize: 26, fontWeight: 500 }}>
					Descrição: {descricao}
				</CustomTypography>
			</Box>
		</Box>
