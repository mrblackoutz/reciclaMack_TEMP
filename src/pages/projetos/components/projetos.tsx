...
const ItemProjetos = ({
	...
	imagem: string
	altText: string
	corBotao: 'success' | 'secondary' | 'primary' | 'inherit' | 'error' | 'info' | 'warning'
}) => {
	...
	return (
		...
		>
			...
			<Box component='img' src={imagem} alt={altText} sx={{ borderRadius: 2, mb: 2, width: '100%', height: 'auto' }} />
			<Button variant='contained' color={corBotao} sx={{ borderRadius: 1, fontFamily: theme.typography.fontFamily }}>
...
const Projetos = () => {
	return (
		<Box sx={{ width: '100%', minHeight: 616, bgcolor: 'white' }}>
			<CustomTypography variant='h4' fontWeight='600' sx={{ my: 4, textAlign: 'center' }}>
