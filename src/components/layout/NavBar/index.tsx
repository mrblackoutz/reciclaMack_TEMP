...
const NavBar = () => {
	...
	const { isDarkMode, toggleDarkMode, colorblindMode, toggleColorblindMode, increaseFontSize, decreaseFontSize } =
		useThemeContext()
	React.useEffect(() => {
					...
					<Grid container alignItems='center' justifyContent='space-between'>
						...
						<Grid size={4}>
							<StyledLink href={'/'}>
								...
								>
									<Image src='/mackenzie.svg' layout='fill' objectFit='contain' alt='Mackenzie Logo' />
								</Box>
							</StyledLink>
						</Grid>
						{/* Links */}
